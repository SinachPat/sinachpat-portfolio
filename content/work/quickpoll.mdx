...
The host fills in meeting details, optionally adds participants from their contacts or groups (whose connected calendar availability auto-populates), sets a poll expiry date, and configures guest permissions — whether guests can edit meeting details, schedule the meeting manually, or add other participants.
...
<MDXImage src="/images/work/quickpoll-details-form.png" alt="quickpoll sessions" caption="quickpoll sessions"/>
